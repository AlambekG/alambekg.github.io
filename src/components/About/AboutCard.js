        ...
        <blockquote className="blockquote mb-0">
          <p className="home-about-body2">
            <div>
              ...
              <br/>
              <b className="purple medium"> BS in Computer Science and Engineering (2019-2023)</b> 
              </div>
            </div>
            <br />
            <div>
              Experience:
              <div className="aboutDiv"> 
                <span className="large"> Research Software Engineer (Seoul, 2025 July - present) </span>
                <br/>
                <span className="medium"> <a href="https://www.stonelab.kr/" className="purple">  Stonelab inc. </a> 
                , AI healthcare startup </span>
              </div>
              <div className="aboutDiv"> 
                <span className="large"> Software Engineer (Seoul, 2024 March - 2025 June) </span>
                <br/>
                <span className="medium"> <a href="https://www.nepla.net/" className="purple">  Nepla Co. </a> 
                , Legal-tech startup </span>
              </div>
              <div className="aboutDiv"> 
                <span className="large"> Researche Software Engineer, Intern (Ulsan, 2023 July - 2023 September) </span>
                <br/>
              ...
              <div className="aboutDiv"> 
                <span className="large"> Software Engineer, Intern (Seoul, 2022 December - 2023 February)</span>
                <br/>
